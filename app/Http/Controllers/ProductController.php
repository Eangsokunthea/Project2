...
class ProductController extends Controller
{
    ...
    public function all_product(){
        ...
        ->orderby('tbl_product.product_id','desc')->paginate(4); // co the su dung pagination o day!!! 
    ...
    public function unactive_product($product_id){
        ...
        return Redirect::to('all-product')->with('message', 'Không kích hoạt sản phẩm thành công');
