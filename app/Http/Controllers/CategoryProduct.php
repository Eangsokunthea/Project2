...
class CategoryProduct extends Controller
{
    ...
    public function all_category_product(){
        $this->AuthLogin();
    	$all_category_product = DB::table('tbl_category_product')->get(); // co the su dung pagination o day!!! 
    ...
    public function active_category_product($category_product_id){
        ...
        return Redirect::to('all-category-product')->with('message', 'Kích hoạt danh mục sản phẩm thành công');
    }
